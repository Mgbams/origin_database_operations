...
class PostProductModel
{
  ...
  {
    try {
      $request = $this->bdd->prepare("INSERT INTO error(product_no, product_name, product_description, product_price, product_discount, product_featured, product_sizes, product_colors, units_in_stock, product_promo, category_id, supplier_id, cost_price, available, unit_price, image_id) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
